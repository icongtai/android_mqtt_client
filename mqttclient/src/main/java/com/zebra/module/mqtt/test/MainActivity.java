package com.zebra.module.mqtt.test;

import android.app.Activity;
import android.os.Bundle;
import android.view.View;

import com.zebra.module.mqtt.R;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMqttClient = new MqttClient(this.getApplicationContext(), broker,"", options);
    ...
    public StoreMqttConnectOptions getMqttConnectOptions(String userName, String password) {
        final StoreMqttConnectOptions mqttConnectOptions = StoreMqttConnectOptions.get(broker,"");
        // 配置MQTT连接
